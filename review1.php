...
if(isset($_POST['hreview']))
{
	...
	$q=mysql_query("select e.email,e.package_id from booked_package e where e.package_id='$id'");
   ...
   $query="insert into holiday_review(p_id,email,review,rating) values('$hotel','$mail','$r','$rt')";
