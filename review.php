...
if(isset($_POST['hreview']))
{
	...
	$q=mysql_query("select e.email,e.hotel_id from booked_rooms e where e.bookid='$id'");
   ...
   $query="insert into hotel_review(h_id,email,review,rating) values('$hotel','$mail','$r','$rt')";
